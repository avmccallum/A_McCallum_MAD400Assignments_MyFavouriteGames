...
export class ContentListComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.contentList = [{
      ...
      type: "Switch",
      tags: ["Adventure", "Action", "Role-Playing"]
    }, {
      id: 2,
      ...
      creator: "Ubisoft",
      imgURL:"https://macgamesbox.com/wp-content/uploads/Assassins-Creed-Origins-Mac-OS-X.jpg",
